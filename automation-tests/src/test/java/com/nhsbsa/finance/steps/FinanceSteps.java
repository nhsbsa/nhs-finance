...
//        ContributionsAndPaymentPage FinancePages.contributionsAndPaymentPage() = PageFactory.initElements(DriverManager.getDriver(), ContributionsAndPaymentPage.class);
//        FinancePages.setCurrentPage(FinancePages.contributionsAndPaymentPage());
//    }
...
//        FinancePages.§schedulePaymentPage().enterDateOfTransferDay(day);
//        FinancePages.schedulePaymentPage().enterDateOfTransferMonth(month);
//        FinancePages.schedulePaymentPage().enterDateOfTransferYear(year);
//        FinancePages.schedulePaymentPage() = financeLoginPage.submit();
//    }
