...
/**
 * Created by NatHulse on 22/11/2016.
 * This is the page after the ScheduleYourPayment page (once logged in)
 */
public class ContributionsAndPaymentSteps {

    @Given("^contributions and payment page is displayed$")
    public void contribution_and_payment_page_is_displayed() {
        contributionAndPaymentPage = PageFactory.initElements(DriverManager.getDriver(), ConttributionAndPaymentPage.class);
    }
